...
import com.android.akademik_dosen.activity.daftar_mhs;
...
public class adapter_daftar_kuliah_mhs extends RecyclerView.Adapter<adapter_daftar_kuliah_mhs.ViewHolder> {
    private ImageLoader imageLoader;
    private Context context;
    List<Item> dftr;

    public adapter_daftar_kuliah_mhs(List<Item> dftr, Context context){
        super();
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent detail = new Intent(context,daftar_mhs.class);
