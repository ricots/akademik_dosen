package com.android.akademik_dosen;
...
import com.android.akademik_dosen.activity.login;
import com.android.akademik_dosen.fragment.add_dosen;
import com.android.akademik_dosen.fragment.home;
import com.android.akademik_dosen.fragment.matkul;
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    ...
                    case R.id.inbox:
                        ...
                        Bundle bundle_kls = new Bundle();
                        bundle_kls.putString("idkirim","kls");
                        fragment.setArguments(bundle_kls);
                        android.support.v4.app.FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                        fragmentTransaction.replace(R.id.frame,fragment);
                        fragmentTransaction.commit();
                        String kls = "Daftar Kelas";
                        getSupportActionBar().setTitle(kls);
                        return true;

                    // For rest of the options we just show a toast on click

                    case R.id.starred:
                        matkul fragment_dosen = new matkul();
                        Bundle bundle = new Bundle();
                        bundle.putString("idkirim","mhs");
                        fragment_dosen.setArguments(bundle);
